(function(){
  ...
  if(calc){
    var JAARPRIJS=99.99,now=document.getElementById('c-now'),save=document.getElementById('c-save'),big=save.parentElement;
  ...
  function zetWaLinks(){document.querySelectorAll('[data-wa]').forEach(function(a){a.href=waUrl('Hoi Odysstream, ik heb een vraag.');a.target='_blank';a.rel='noopener'})}
  zetWaLinks();
